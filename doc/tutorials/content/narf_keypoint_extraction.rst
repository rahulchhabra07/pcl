...
steps are already covered in the previous tutorial :ref:`range_image_visualization` `Range image visualization <http://www.pointclouds.org/documentation/tutorials/range_image_visualization.php#range-image-visualization>`_ .
